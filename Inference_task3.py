...
from utils.model_task3 import Model
...
from cocoSource_task3 import imageCaptionModel # here you plug in your modelfile depending on what you have developed: simple rnn, 2 layer, or attention, if you have 3 modelfiles a.py b.py c.py then you do: from a import ... or you have one file with n different imgcapmodels
...
if __name__ == '__main__':
    ...
    modelParam = {
        ...
        'modelName': 'model_31/',  # name of your trained model
        'restoreModelLast': 0,
        'restoreModelBest': 0,
